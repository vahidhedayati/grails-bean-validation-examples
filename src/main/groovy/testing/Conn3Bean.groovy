...
class Conn3Bean implements Validateable{
	String host

	// DOUBLE elements of child object so userdetails[0].username userdetails[0].name &&  
	// userdetails[1].username userdetails[1].name
	List<U2Bean> userDetails = [ new U2Bean(), new U2Bean()]
